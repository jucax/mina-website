      ...
      <div className="flex-1 flex flex-col items-center justify-center md:pl-24">
        ...
        <div className="flex flex-row items-center gap-12 mt-2">
          <div className="flex flex-col gap-2">
            <a href="https://apps.apple.com/us/app/mina-real-estate/id6751931320" target="_blank" rel="noopener noreferrer" className="block group"><img src="/assets/appstore-badge.png" alt="Download on the App Store" className="w-44 md:w-52 transition-all duration-200 group-hover:shadow-[6px_6px_0_0_#ff9800] group-hover:border-r-4 group-hover:border-b-4 group-hover:border-orange-400 rounded-xl" /></a>
            <a href="https://play.google.com/store/apps/details?id=com.minaios" target="_blank" rel="noopener noreferrer" className="block group"><img src="/assets/googleplay-badge.png" alt="Get it on Google Play" className="w-44 md:w-52 transition-all duration-200 group-hover:shadow-[6px_6px_0_0_#ff9800] group-hover:border-r-4 group-hover:border-b-4 group-hover:border-orange-400 rounded-xl" /></a>
          </div>
